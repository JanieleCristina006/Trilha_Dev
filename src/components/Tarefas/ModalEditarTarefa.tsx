...
type ModalEditarProps = {
  ...
  aoFechar: () => void
  tarefa: Tarefa
  aoSalvar: (tarefaAtualizada: Tarefa) => void
  aoExcluir: () => void
}
        ...
        <div className="fixed inset-0 overflow-y-auto">
          <div className="flex min-h-full items-center justify-center p-4">
            <Dialog.Panel className="w-full max-w-lg rounded-xl bg-white dark:bg-gray-800 p-6 shadow-xl transition-colors duration-300">
              <Dialog.Title className="text-lg font-bold text-gray-800 dark:text-white mb-6">
                Editar Tarefa ✏️
              </Dialog.Title>
              ...
              >
                ...
                <div>
                  ...
                  <div className="flex gap-2 mt-1">
                    ...
                    <button
                      ...
                      className="bg-indigo-600 text-white px-3 py-2 text-sm rounded hover:bg-indigo-500 transition"
                    >
                      Adicionar
                    </button>
                  </div>
                    ...
                    {tags.map((tag, index) => (
                      ...
                      >
                        ...
                        <button
                          ...
                          className="text-emerald-500 hover:text-emerald-700 dark:hover:text-emerald-200 text-[12px] -mr-1"
                          title="Remover"
                        >
                          ×
                        </button>
                ...
                <div className="flex justify-between pt-4">
                  <button
                    type="button"
                    onClick={aoExcluir}
                    className="px-4 py-2 rounded bg-red-100 dark:bg-red-900 text-red-600 dark:text-red-300 hover:bg-red-200 dark:hover:bg-red-800 text-sm transition"
                  >
                    Excluir
                  </button>
                  ...
                  <div className="flex gap-2">
                    <button
                      type="button"
                      onClick={aoFechar}
                      className="px-4 py-2 rounded bg-gray-200 dark:bg-gray-600 text-sm text-gray-800 dark:text-white hover:bg-gray-300 dark:hover:bg-gray-500 transition"
                    >
                      Cancelar
                    </button>
                    <button
                      type="submit"
                      className="px-4 py-2 rounded bg-indigo-600 text-white hover:bg-indigo-500 text-sm transition"
                    >
                      Salvar alterações
                    </button>
                  </div>
